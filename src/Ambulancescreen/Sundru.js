...
const Sundru = () => {
  ...
  const sundruPhoto = require('./sundru.jpg');

  const handleCallPress = () => {
    const phoneNumber = '+91 9961720963';
  ...
  const handleWhatsAppPress = () => {
    const whatsappNumber = '+91 9961720963';
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.orangeBackground}>
          <TouchableOpacity onPress={() => setModalVisible(true)}>
            <Image source={sundruPhoto} style={styles.profilePicture} />
          </TouchableOpacity>
          <Text style={styles.name}>Sundru</Text>
          {renderRatingBar(4)}
        </View>
        ...
        <Text style={styles.description}>
          Welcome to Sundru's profile. He is an experienced professional with 45 years of expertise
      ...
      >
        <View style={styles.modalContainer}>
          ...
          <Image source={sundruPhoto} style={styles.modalProfilePicture} resizeMode="contain" />
        </View>
      </Modal>
    </SafeAreaView>
  );
