...
const Abhishek = () => {
  ...
  const abhishekPhoto = require('./abh.jpg');

  const handleCallPress = () => {
    const phoneNumber = '+91 9526141746';
  ...
  const handleWhatsAppPress = () => {
    const whatsappNumber = '+91 9526141746';
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.orangeBackground}>
          <TouchableOpacity onPress={() => setModalVisible(true)}>
            <Image source={abhishekPhoto} style={styles.profilePicture} />
          </TouchableOpacity>
        ...
        <Text style={styles.description}>
          Welcome to Abhishek's profile. He is an experienced professional with 45 years of expertise
      ...
      >
        <View style={styles.modalContainer}>
          ...
          <Image source={abhishekPhoto} style={styles.modalProfilePicture} resizeMode="contain" />
        </View>
      </Modal>
    </SafeAreaView>
  );
