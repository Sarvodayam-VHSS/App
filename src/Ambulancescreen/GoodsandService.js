...
const data = [
  { name: 'Sundru', age: 35, experience: '45 years', place: 'Mundathicode', pfp: require('../Ambulancescreen/sundru.jpg') },
...
const GoodsandService = () => {
  ...
  const handleItemPress = (item) => {
    ...
    if (item.name === 'Sundru') {
      navigation.navigate('Sundru'); // Make sure you have a screen named 'Sundru' in your navigation stack
    }
...
export default GoodsandService;
