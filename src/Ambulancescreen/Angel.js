...
const Angel = () => {
  ...
  const angelPhoto = require('./angel.jpg');

  const handleCallPress = () => {
    const phoneNumber = '+91 8848365840';
  ...
  const handleWhatsAppPress = () => {
    const whatsappNumber = '+91 8848365840';
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.orangeBackground}>
          <TouchableOpacity onPress={() => setModalVisible(true)}>
            <Image source={angelPhoto} style={styles.profilePicture} />
          </TouchableOpacity>
        ...
        <Text style={styles.description}>
          Welcome to Angel's profile. He is an experienced professional with 45 years of expertise
      ...
      >
        <View style={styles.modalContainer}>
          ...
          <Image source={angelPhoto} style={styles.modalProfilePicture} resizeMode="contain" />
        </View>
      </Modal>
    </SafeAreaView>
  );
