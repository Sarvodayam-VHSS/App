...
const data = [
  { id: '0', category: 'Doctor', name: 'John', age: 35, experience: '5 years', place: 'New York', pfp: require('../assets/ronaldo.jpg') },
  { id: '1', category: 'Home Nurse', name: 'James', age: 40, experience: '8 years', place: 'Los Angeles', pfp: require('../assets/messi.jpg') },
  { id: '2', category: 'Medical Assistant', name: 'Wick', age: 45, experience: '10 years', place: 'Chicago', pfp: require('../assets/jude.jpeg') },
  { id: '3', category: 'Physical Therapist', name: 'Alfred', age: 38, experience: '6 years', place: 'San Francisco', pfp: require('../assets/neymar.jpg') },
