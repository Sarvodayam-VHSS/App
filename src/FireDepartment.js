...
const data = [
  { id: '0', category: 'Firefighter', name: 'John', age: 35, experience: '5 years', place: 'New York', pfp: require('../assets/ronaldo.jpg') },
  { id: '1', category: 'Fire Captain', name: 'James', age: 40, experience: '8 years', place: 'Los Angeles', pfp: require('../assets/messi.jpg') },
  { id: '2', category: 'Fire Inspector', name: 'Wick', age: 45, experience: '10 years', place: 'Chicago', pfp: require('../assets/jude.jpeg') },
  { id: '3', category: 'Fire Prevention Specialist', name: 'Alfred', age: 38, experience: '6 years', place: 'San Francisco', pfp: require('../assets/neymar.jpg') },
